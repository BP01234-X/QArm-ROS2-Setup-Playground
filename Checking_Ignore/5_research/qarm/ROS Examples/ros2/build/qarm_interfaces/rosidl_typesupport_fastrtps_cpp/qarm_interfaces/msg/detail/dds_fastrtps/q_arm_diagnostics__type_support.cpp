...
#include "qarm_interfaces/msg/detail/q_arm_diagnostics__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  // Member: joint_pwms
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.joint_pwms[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = qarm_interfaces::msg::QArmDiagnostics;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const qarm_interfaces::msg::QArmDiagnostics *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<qarm_interfaces::msg::QArmDiagnostics *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _QArmDiagnostics__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const qarm_interfaces::msg::QArmDiagnostics *>(
...
static size_t _QArmDiagnostics__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_QArmDiagnostics(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _QArmDiagnostics__callbacks = {
  "qarm_interfaces::msg",
  "QArmDiagnostics",
...
static rosidl_message_type_support_t _QArmDiagnostics__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_QArmDiagnostics__callbacks,
...
{
  return &qarm_interfaces::msg::typesupport_fastrtps_cpp::_QArmDiagnostics__handle;
}
